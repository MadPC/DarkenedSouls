...
public class ChunkProviderDark implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderDark(World par1World, long par2, boolean par4)
    {
            ...
            for (int l = 0; l < 16; ++l)
            {
                ...
                for (int k1 = 127; k1 >= 0; --k1)
                {
                    ...
                    else
                    {
                        ...
                        else if (b3 == ModBlocks.ShadowStone.blockID)
                        {
                            if (j1 == -1)
                            {
                                if (i1 <= 0)
                                {
                                    b1 = 0;
                                    b2 = (byte)ModBlocks.ShadowStone.blockID;
                                }
